...
switch($_GET['Pa']){
	...
	<div>
		...
		<div class="CMS_TabContent">
			...
			<div class="CMS_New_Cont">
				...
				<div>
					<div placeholder="Handle for the <form>">Name field</div><input id="CMS_Form_field_" name="CMS_Form_field_7" type="text" required /></div>
				</div>
				<div>
				...
				<div>
					<div placeholder="True or False">Is this field required?</div><div><input id="CMS_Form_field_4" name="CMS_Form_field_4" type="text" required /></div>
				</div>
				<div>
	...
	<div class="CMS_La_M">
		...
		<div class="CMS_La_S">
			...
			<div id=""><?PHP CMS_GrabAllForms('CMS_EDI_E2'); echo $GAF; ?></div>
		</div>
		<div class="CMS_La_S">
	...
	<div>
		...
		<div class="CMS_TabContent">
			...
			<div class="CMS_New_Cont">
				...
				<div>
					<div>Language</div><div><?PHP echo $GxZ; ?></div>
				</div>
				<div>
	...
	<div class="CMS_La_M">
		...
		<div class="CMS_La_S">
			...
			<div id="CMS_EDI_E6"><?PHP CMS_Rights_Labels('CMS_EDI_E6'); echo $GsQ; ?></div>
		</div>
		<div class="CMS_La_S">
			<div id="CMS_EDI_L7">Writing Rights</div>
			<div id="CMS_EDI_E7"><?PHP CMS_Rights_Labels('CMS_EDI_E7'); echo $GsQ; ?></div>
		</div>
		<div class="CMS_La_S">
