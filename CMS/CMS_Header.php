<?PHP include_once __dir__ . "CMS_Connection.php";	
session_start();
...
if($CMS_Rights5['read_write_id'], $_SESSION['CMS_3']){$CMS_Write = 1} else { $CMS_Write = 0 }
if(in_array($CMS_Rights5['read_id'], $_SESSION['CMS_3']) || $CMS_Rights5['read_write_id'], $_SESSION['CMS_3']) || $CMS_Rights5['read__id'] === 0){
 ?>
<html lang="en">
<head>
	<?PHP include_once __dir__ . "CMS_Head.html" ;?>
